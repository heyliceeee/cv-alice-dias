                ...
                <form action="https://getform.io/f/aejrjzwb" method='POST' className="xl:pl-10 2xl:pl-20">
                    <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                        <div className="mb-4">
                            ...
                            <input id='name' type="text" name='name' autoComplete='name' required placeholder='Alice Dias' className="text-field reveal-up" />
                        </div>

                        <div className="mb-4">
                            <label htmlFor="email" className="label reveal-up">Email</label>
                            <input id='email' type="email" name='email' autoComplete='email' required placeholder='alice@example.com' className="text-field reveal-up" />
                        </div>
                    </div>

                    <div className="mb-4">
                        <label htmlFor="message" className="label reveal-up">Message</label>
                        <textarea name="message" id="message" required placeholder='Hi!' className="text-field resize-y min-h-32 max-h-80 reveal-up"></textarea>
                    </div>
